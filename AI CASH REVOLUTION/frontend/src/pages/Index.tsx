...
import { TradeExecutionPanelV2 } from "@/components/TradeExecutionPanel_V2_CLEAN";
...
const Index = () => {
  ...
  const [analysisSignal, setAnalysisSignal] = useState<any>(null);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="p-3 sm:p-4">
        ...
        {/* SISTEMA IBRIDO: Analisi + Esecuzione */}

        {/* 1. Trade Analysis Panel (VECCHIO SISTEMA - Solo Analisi) */}
        <div className="mb-6">
          <TradeAnalysisPanel
            symbol={selectedSymbol}
            onSignalGenerated={setAnalysisSignal}
          />
        </div>

        {/* 2. AI Analysis Panel (NUOVO SISTEMA - AI Avanzata) */}
        <div className="mb-6">
          <AIAnalysisPanel
            symbol={selectedSymbol}
            onSignalGenerated={setLatestSignal}
        ...
        {/* 3. Trade Execution Panel V2 (ESECUZIONE CON POPUP) */}
        <TradeExecutionPanelV2
          symbol={selectedSymbol}
          signal={latestSignal || analysisSignal} // Usa entrambi i segnali
        />
